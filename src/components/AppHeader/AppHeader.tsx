...
import { GlobalOutlined, LogoutOutlined, UserOutlined, SunOutlined, MoonOutlined, DesktopOutlined } from '@ant-design/icons';
import { useNavigate } from '@tanstack/react-router';
import { useThemeStore } from '@/themes/themeStore';
import { useAuth } from '@/auth/AuthContext';
import { ERoutes } from '@/routes';
import { LANGUAGES, LANGUAGE_LABELS, STORAGE_KEY as LANG_STORAGE_KEY } from '@/i18n/i18n';
  ...
  return (
    <div className={styles.toolbar}>
      ...
      <Select
        ...
        style={{ width: 80 }}
        options={LANGUAGES.map((lang) => ({ value: lang, label: LANGUAGE_LABELS[lang] }))}
