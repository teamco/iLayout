  ...
  return (
    <div className={styles.overlay}>
      <svg width={canvasWidth} height={canvasHeight}>
        <defs>
          <pattern id={colPatternId} x="0" y="0" width={colPatternWidth} height={canvasHeight} patternUnits="userSpaceOnUse">
            <rect x="0" y="0" width={colWidth} height={canvasHeight} fill={COL_FILL} />
          </pattern>
          {layoutMode === 'scroll' && (
            <pattern id={rowPatternId} x="0" y="0" width={canvasWidth} height={rowPatternHeight} patternUnits="userSpaceOnUse">
